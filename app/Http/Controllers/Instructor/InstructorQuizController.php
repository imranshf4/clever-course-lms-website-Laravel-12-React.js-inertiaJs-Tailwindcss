...
class InstructorQuizController extends Controller
{
    ...
    public function addQuiz()
    {
        ...
        $modules = Module::get();
        return inertia('instructor/backend/quizzes/addQuiz',[
            'courses' => $courses,
            'modules' => $modules,
        ]);
    } //end method
    ...
    public function allQuiz()
    {
        ...
        $courses = Course::where('admin_id', Auth::id())->get();
        $modules = Module::get();
        return inertia('instructor/backend/quizzes/allQuiz', [
            'quizzes' => $quizzes,
            'courses' => $courses,
            'modules' => $modules,
        ]);
    ...
    public function editQuiz($id)
    {
        ...
        $courses = Course::where('admin_id', Auth::id())->get();
        $modules = Module::get();
        return inertia('instructor/backend/quizzes/editQuiz', [
            'quiz' => $quiz,
            'courses' => $courses,
            'modules' => $modules,
        ]);
    ...
    public function updateQuiz(Request $request)
    {
        ...
        return redirect()->route('instructor.all.quiz')->with('success', "Quiz updated successfully");
    } //end method
