...
class InstructorLessonController extends Controller
{
    ...
    public function addLesson()
    {
        ...
        $modules = Module::get();
        return inertia('instructor/backend/lessons/addLesson', [
            'courses' => $courses,
            'modules' => $modules
        ]);
    ...
    public function storeLesson(Request $request)
    {
        ...
        return redirect()->route('instructor.all.lesson')->with('success', 'Lesson created successfully.');
    }
    ...
    public function allLesson()
    {
        ...
        return inertia('instructor/backend/lessons/allLesson', [
            'lessons' => $lessons,
            'modules' => $modules,
            'courses' => $courses
        ]);
    ...
    public function editLesson($id)
    {
        ...
        return inertia('instructor/backend/lessons/editLesson', [
            'lesson' => $lesson,
            'modules' => $modules,
            'courses' => $courses
        ]);
    ...
    public function updateLesson(Request $request, $id)
    {
        ...
        return redirect()->route('instructor.all.lesson')->with('success', 'Lesson updated successfully.');
    }
