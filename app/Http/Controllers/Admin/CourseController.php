...
class CourseController extends Controller
{
    ...
    public function addCourse()
    {
        ...
        return inertia('admin/backend/courses/addCourse', [
    ...
    public function storeCourse(Request $request)
    {
        ...
        return redirect()->route('all.course')->with('success', 'Course added successfully.');
    }
    //end method
    ...
    public function allCourse()
    {
        ...
        return inertia('admin/backend/courses/allCourse', [
            'courses' => $courses,
        ]);
    } //end method
    ...
    public function editCourse($id)
    {
        $course = Course::findOrFail($id);
        $categories = Category::latest()->get();
        return inertia('admin/backend/courses/editCourse', [
            'course' => $course,
            'categories' => $categories,
        ]);
    } //end method
