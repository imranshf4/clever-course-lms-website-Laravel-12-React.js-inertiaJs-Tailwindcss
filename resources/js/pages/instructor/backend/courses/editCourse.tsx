...
import { CategoryWithId, Course, CourseWithId } from '@/types';
...
const EditCourse = ({ course,categories }: EditCourseProps) => {
    ...
    const submit: FormEventHandler = (e) => {
        ...
        post(route('update.course', { id: course.id }), {
    ...
    return (
        <AppLayout>
            <PageBreadcrumb pageTitle="Edit Course" subTitle="All Course" link="/all/course" />
            ...
            <div>
                <div className="space-y-6 rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
                    <form onSubmit={submit} encType="multipart/form-data">
                        ...
                        <div className="mt-4">
                            <img
                                src={previewUrl ? previewUrl : typeof course.image === 'string' ? course.image : '/backend/no_image.jpg'}
                        ...
                        <div>
                            <Button
                                ...
                                disabled={processing}
                            >
                                {processing && <LoaderCircle className="h-4 w-4 animate-spin" />}Update Course
                            </Button>
                        </div>
                    </form>
                </div>
