...
import { CourseWithId, ModuleWithId, Quiz, QuizWithId } from '@/types';
...
const EditQuiz = ({ courses, modules, quiz }: CoursesProps) => {
    const { flash } = usePage<CustomPageProps>().props;
    const [selectedCourseId, setSelectedCourseId] = useState(String(quiz.course_id || ''));
    ...
    const submit: FormEventHandler = (e) => {
        ...
        post(route('update.quiz',{id:quiz.id}), {
            onFinish: () => {
