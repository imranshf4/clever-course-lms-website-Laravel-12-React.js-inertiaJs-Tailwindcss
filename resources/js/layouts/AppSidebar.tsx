...
import { ChevronDownIcon, GridIcon, HorizontaLDots, ListIcon, UserCircleIcon } from '@/icons';
...
const navItems: NavItem[] = [
    ...
    {
        icon: <UserCircleIcon />,
        name: 'User Profile, Badges & Certificates',
        path: '/user/profile',
    },
    {
        name: 'View Quiz Score',
        icon: <ListIcon />,
        path: '/user/quiz-score',
    },
    {
        name: 'Attended Courses',
        icon: <ListIcon />,
        path: '/user/attended/course',
    },
    {
        name: 'Booked Courses',
        icon: <ListIcon />,
        path: '/user/booked/course',
    },
    {
        name: 'Confirmed Courses',
        icon: <ListIcon />,
        path: '/user/confirmed/course',
    },
];
