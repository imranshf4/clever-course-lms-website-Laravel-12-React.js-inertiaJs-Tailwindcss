...
const navItems: NavItem[] = [
    ...
    },
    {
        ...
        icon: <ListIcon />,
        subItems: [
            { name: 'Add Slider', path: '/add/slider' },
            { name: 'All Slider', path: '/all/slider' },
        ],
    },
    {
        ...
        subItems: [
            ...
            { name: 'All Category', path: '/all/category' },
        ],
    },
    {
        name: 'Course Manage',
        ...
        subItems: [
            ...
            { name: 'All Course', path: '/all/course' },
        ],
    },
    {
        name: 'Module Manage',
        icon: <ListIcon />,
        subItems: [
            { name: 'Add Module', path: '/add/module' },
            { name: 'All Module', path: '/all/module' },
        ],
    },
    {
        name: 'Lesson Manage',
        icon: <ListIcon />,
        subItems: [
            { name: 'Add Lesson', path: '/add/lesson' },
            { name: 'All Lesson', path: '/all/lesson' },
        ],
    },
    {
        name: 'Quiz Manage',
    ...
    },
    {
        ...
        icon: <ListIcon />,
        subItems: [
            { name: 'All Instructor', path: '/all/instructor' },
        ],
    },
    {
        name: 'Rating Manage',
        icon: <ListIcon />,
        subItems: [
            { name: 'All Rating', path: '/all/rating' },
        ],
    },
    {
        name: 'Order Manage',
        icon: <ListIcon />,
        subItems: [
            { name: 'Confirmed Order', path: '/confirmed/order' },
        ],
    },
];
