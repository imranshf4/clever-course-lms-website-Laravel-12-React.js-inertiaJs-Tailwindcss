    ...
    return (
        <div className="relative">
            ...
            >
                ...
                <span className="text-theme-sm mr-1 block font-medium">{auth.user.username ? auth.user.username : 'set username'}</span>
                <svg
            ...
            >
                <div className='pl-5'>
                    <span className="text-theme-sm block font-medium text-gray-700 dark:text-gray-400">{auth.user.name}</span>
