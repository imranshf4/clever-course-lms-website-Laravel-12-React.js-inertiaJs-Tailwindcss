...
export default function SignInForm({ status, canResetPassword }: LoginProps) {
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        <input type='checkbox'
                                            ...
                                            tabIndex={3}
                                        />
                                        <label className="text-theme-sm block font-normal text-gray-700 dark:text-gray-400" htmlFor="remember">Keep me logged in</label>
                                    </div>
                                    {canResetPassword && (
                                        <Link href={route('password.request')} className="text-brand-500 ml-auto text-sm" tabIndex={5}>
                                            Forgot password?
                                        </Link>
                                    )}
                                </div>
                                <div>
                                    <Button className="bg-brand-500 w-full text-white">Sign in</Button>
                                </div>
                            </div>
                        </form>
