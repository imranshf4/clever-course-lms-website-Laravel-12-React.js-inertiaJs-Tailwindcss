        ...
        <div className="relative">
            ...
            >
                <span className="mr-3 h-11 w-11 overflow-hidden rounded-full">
                    <img src={String(auth.user.photo) || '/backend/no_image.jpg'} alt="User" />
                </span>

                <span className="text-theme-sm mr-1 block font-medium capitalize">{auth.user.username ? auth.user.username : 'set username'}</span>
                <svg
            ...
            >
                <div>
                    <span className="text-theme-sm block font-medium text-gray-700 capitalize dark:text-gray-400">{auth.user.name}</span>
                    <span className="text-theme-xs mt-0.5 block text-gray-500 dark:text-gray-400">{auth.user.email}</span>
                </div>
